...
class Actor1:
    def __init__(self,data:int):
        self.data = data;
        self.two = Actor2.remote(self,self.data)
...
class Actor2:
    ...
    def increment_data(self):
        self.data += 1;
        try:
            self.one.set_data.remote(self.data); #raises AttributeError: 'function' object has no attribute 'remote
        except:
            self.one.set_data(self.data);
...
if __name__ == "__main__":
    ...
    print(ray.get(a1.get_other_data.remote())); #prints '2'
    ...
    print(ray.get(a1.get_other_data.remote())); #prints '3' - a1 able to increment a2's data
